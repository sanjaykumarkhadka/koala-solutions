...
export const demoCandidates = [
  {
    ...
    tenantId: demoTenant.id,
    userId: 'demo-candidate-user-001',
    skills: ['JavaScript', 'React', 'Node.js', 'Python'],
    experience: 7,
    education: 'B.Tech Computer Science',
    currentLocation: 'Mumbai, India',
    preferredLocations: ['United States', 'Canada', 'United Kingdom'],
    expectedSalary: '$120,000 - $150,000',
    status: 'ACTIVE',
    user: {
      id: 'demo-candidate-user-001',
      firstName: 'Alex',
      lastName: 'Kumar',
...
// Demo Team (with _count for TeamManagement page)
